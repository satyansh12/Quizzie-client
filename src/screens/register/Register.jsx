...
/**
 *
 * Register.jsx handles user registration and login functionalities.
 * It's used in the authentication flow, allowing new users to sign up and existing users to log in.
 */
const Register = () => {
